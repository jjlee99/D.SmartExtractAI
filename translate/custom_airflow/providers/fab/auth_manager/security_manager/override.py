...
class FabAirflowSecurityManagerOverride(AirflowSecurityManagerV2):
    ...
    def register_views(self):
        ...
        self.user_view = self.appbuilder.add_view(
            ...
            "List Users",
            icon="fa-user",
            label=trs_label.get("providers_fab_auth_manager_security_manager_override", {}).get("User_label"),
            category="Security",
        ...
        role_view = self.appbuilder.add_view(
            ...
            "List Roles",
            icon="fa-group",
            label=trs_label.get("providers_fab_auth_manager_security_manager_override", {}).get("Role_label"),
            category="Security",
            category_icon="fa-cogs",
            category_label=trs_label.get("providers_fab_auth_manager_security_manager_override", {}).get("category"),
        )
        ...
        if self.userstatschartview:
            self.appbuilder.add_view(
                ...
                "User's Statistics",
                icon="fa-bar-chart-o",
                label=trs_label.get("providers_fab_auth_manager_security_manager_override", {}).get("User_stat_label"),
        ...
        if self.auth_user_registration:
            self.appbuilder.add_view(
                ...
                "User Registrations",
                icon="fa-user-plus",
                label=trs_label.get("providers_fab_auth_manager_security_manager_override", {}).get("User_register_label"),
                category="Security",
                category_label=trs_label.get("providers_fab_auth_manager_security_manager_override", {}).get("category"),
            )
        ...
        if self.appbuilder.get_app.config.get("FAB_ADD_SECURITY_PERMISSION_VIEW", True):
            self.appbuilder.add_view(
                ...
                "Actions",
                icon="fa-lock",
                label=trs_label.get("providers_fab_auth_manager_security_manager_override", {}).get("Actions_label"),
                category="Security",
                category_label=trs_label.get("providers_fab_auth_manager_security_manager_override", {}).get("category"),
            )
        if self.appbuilder.get_app.config.get("FAB_ADD_SECURITY_VIEW_MENU_VIEW", True):
            self.appbuilder.add_view(
                ...
                "Resources",
                icon="fa-list-alt",
                label=trs_label.get("providers_fab_auth_manager_security_manager_override", {}).get("resource_label"),
                category="Security",
                category_label=trs_label.get("providers_fab_auth_manager_security_manager_override", {}).get("category"),
            )
        if self.appbuilder.get_app.config.get("FAB_ADD_SECURITY_PERMISSION_VIEWS_VIEW", True):
            self.appbuilder.add_view(
                ...
                "Permission Pairs",
                icon="fa-link",
                label=trs_label.get("providers_fab_auth_manager_security_manager_override", {}).get("permission_label"),
                category="Security",
                category_label=trs_label.get("providers_fab_auth_manager_security_manager_override", {}).get("category"),
            )
        
        self.appbuilder.menu.menu.insert(-3, self.appbuilder.menu.menu.pop()) 
