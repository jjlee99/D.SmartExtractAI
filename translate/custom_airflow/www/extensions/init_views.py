...
def init_appbuilder_views(app):
    ...
    #     permissions.RESOURCE_TRIGGER,label=trs_label.get("www_extensions_init_views", {}).get("trigger_label"),
    #     category=trs_label.get("www_extensions_init_views", {}).get("browse_category"),
    #     # category=permissions.RESOURCE_BROWSE_MENU,
    # )
    ...
    #             category="Security",
    #             category_label=trs_label.get("www_extensions_init_views", {}).get("browse_category")
    #         )
    ...
    #     category=trs_label.get("www_extensions_init_views", {}).get("admin_category"),
    #     # category=permissions.RESOURCE_ADMIN_MENU,
    ...
    # )
    # appbuilder.add_view(
    #     views.ProviderView, permissions.RESOURCE_PROVIDER,label=trs_label.get("www_extensions_init_views", {}).get("provider_label"), category=trs_label.get("www_extensions_init_views", {}).get("admin_category"), 
    # )
    appbuilder.add_view(
        views.PoolModelView, permissions.RESOURCE_POOL, label=trs_label.get("www_extensions_init_views", {}).get("pool_label"), category=trs_label.get("www_extensions_init_views", {}).get("admin_category"), 
    )
